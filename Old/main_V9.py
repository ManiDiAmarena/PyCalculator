...
class Calcolatrice:
    def __init__(self, master):
        ...
        style = ttk.Style()
        # --- NUOVA RIGA: Applica il tema 'clam' ---
        try:
        ...
        layout_pulsanti = [
            ...
            ('1/x', 0, 3, 1, 1, 'funzione_placeholder'),
        ...
        style.configure("Modalita.TButton", 
                        font=common_font, 
                        padding=common_padding, 
                        background=colore_modalita_inattiva,
                        foreground='black',    
                        relief=tk.RAISED)      
        style.map("Modalita.TButton",
                  foreground=common_foreground_black,
                  background=[('!disabled', colore_modalita_inattiva), ('active', colore_modalita_inattiva)], 
                  relief=[('pressed', tk.SUNKEN), ('active', tk.GROOVE), ('!active', tk.RAISED)])

        style.configure("ModalitaAttiva.TButton", 
                        font=common_font, 
                        padding=common_padding, 
                        background=colore_modalita_attiva, 
                        foreground='black', 
                        relief=tk.SUNKEN)     
        style.map("ModalitaAttiva.TButton",
                  foreground=common_foreground_black, 
                  background=[('!disabled', colore_modalita_attiva), ('active', colore_modalita_attiva)], 
                  relief=[('pressed', tk.SUNKEN), ('active', tk.GROOVE), ('!active', tk.SUNKEN)])
        ...
        for (testo, riga, col, cspan, rspan, tipo) in layout_pulsanti:
            ...
            elif tipo in ['parentesi', 'funzione_unaria', 'costante', 'funzione_trig', 'funzione_trig_inv', 'funzione_placeholder']: 
    ...
    def gestisci_click(self, testo_pulsante):
        # (La logica di gestisci_click rimane invariata rispetto all'ultima versione)
        numeri = "0123456789"
        operatori_base = "+-*/"
